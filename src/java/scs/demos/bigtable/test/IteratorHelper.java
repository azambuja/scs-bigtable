...
/**
* scs/demos/bigtable/test/IteratorHelper.java .
...
{
  private static String  _id = "IDL:scs/demos/bigtable/test/Iterator:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (scs.demos.bigtable.test.IteratorHelper.id (), "Iterator", __typeCode);
    }
    return __typeCode;
  }
