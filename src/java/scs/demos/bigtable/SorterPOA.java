 ...
 implements scs.demos.bigtable.SorterOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getKeysOnRange", new java.lang.Integer (2));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 2:  // scs/demos/bigtable/Sorter/getKeysOnRange
       {
         int reducerId = in.read_long ();
         int numReducers = in.read_long ();
         scs.demos.bigtable.KeysHolder keys = new scs.demos.bigtable.KeysHolder ();
         this.getKeysOnRange (reducerId, numReducers, keys);
         out = $rh.createReply();
         scs.demos.bigtable.KeysHelper.write (out, keys.value);
         break;
       }
