...
public class _SorterStub extends org.omg.CORBA.portable.ObjectImpl implements scs.demos.bigtable.Sorter
{
  ...
  public void getKeysOnRange (int reducerId, scs.demos.bigtable.KeysHolder keys)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getKeysOnRange", true);
                $out.write_long (reducerId);
                $in = _invoke ($out);
                keys.value = scs.demos.bigtable.KeysHelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
