 ...
 implements scs.demos.mapreduce.WorkerOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("ping", new java.lang.Integer (3));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // scs/demos/mapreduce/Worker/start
       {
         String configFileName = in.read_string ();
         ...
         scs.core.IComponent workerComponent = scs.core.IComponentHelper.read (in);
         boolean $result = false;
         $result = this.start (configFileName, nodeName, channel, reporter, workerComponent);
         out = $rh.createReply();
       ...
       case 3:  // scs/demos/mapreduce/Worker/ping
       {
         boolean $result = false;
         $result = this.ping ();
         out = $rh.createReply();
