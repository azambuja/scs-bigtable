...
echo Gerando bigTable.jar
javac  -nowarn scs/demos/bigtable/*.java
javac  -nowarn scs/demos/bigtable/servant/*.java
javac  -nowarn scs/demos/bigtable/test/*.java
javac  -nowarn scs/demos/bigtable/test/servant*.java

jar cf bigTable.jar scs/demos/bigtable/*.class scs/demos/bigtable/servant/*.class scs/demos/bigtable/test/*.class scs/demos/bigtable/test/servant/*.class 
